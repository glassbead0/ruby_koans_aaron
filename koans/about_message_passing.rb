...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # My guess is that programmers might define a method called send
    # to do some other functionality (since its such a common word)
    # but you would still want access to the native send method, thus __send__
  end
