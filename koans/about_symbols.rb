...
class AboutSymbols < Neo::Koan
  ...
  # not sure. Maybe because a symbol build from string concatenation does not really have any relationship to the strings, and you dont want to start confusing the two
end
