...
class AboutClassMethods < Neo::Koan
  ...
  # I prefer the first. The second way seems to over complicate things, as
  # you have another class statement inside the class. Not sure what the
  # advantages of using the second method are.
